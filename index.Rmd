...
---
**Note: This is a living document and is under continuous development and review.**
---
...
1. Review the standards on directory structure, file names and compression.
2. Follow the standards regarding the types of data you will be working with.
3. If the file types and workflows you are working with have not been documented, please add a record.
